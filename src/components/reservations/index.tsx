...
return (
    ...
    >
        <View style={[global.content, {paddingBottom: 60}]}>
 
          <View style={styles.itemCard}>
            <View style={styles.cardHeader}>
              <MaterialIcons name="king-bed" size={20} color="#07042b" />
              <Text style={styles.roomLabel}>Quarto Píxie</Text>
            </View>
            ...
            <View style={styles.infoGrid}>
              <View style={styles.infoBox}>
                ...
                <Text style={styles.infoText}>{checkIn || "13/02/2026"}</Text>
              </View>
              <View style={styles.infoBox}>
                <Text style={styles.miniLabel}>SAÍDA</Text>
                <Text style={styles.infoText}>{checkOut || "17/02/2026"}</Text>
              </View>
              <View style={styles.infoBox}>
          ...
          <View style={styles.priceCard}>
            ...
            <View style={styles.priceRow}>
              ...
              <Text style={styles.priceValue}>R$ 1.000,00</Text>
            </View>
            ...
            <View style={styles.priceRow}>
              <Text style={styles.discountsLabel}>Descontos</Text>
              <Text style={styles.discountsValue}>R$ -209,00</Text>
            </View>
            ...
            <View style={styles.priceRow}>
              ...
              <Text style={styles.totalPrice}>R$ 836,00</Text>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  discountsLabel: { color: "#28A745"},
  discountsValue: { fontWeight: "500", color: "#28A745"},
  ...
  totalPrice: { fontSize: 20, fontWeight: "bold", color: "#1d3a47"},
  buttonArea: {
    marginTop: 30,
    gap: 12,
  },
